...
if settings.DEV:
	...
	help_templates = Jinja2Templates(directory='documentation/site')

	@app.get('/', status_code=HTTPStatus.OK, response_class=HTMLResponse)  # type: ignore[misc]
	async def mkdocs(request: Request) -> HTMLResponse:
		...
		"""
		return help_templates.TemplateResponse(name='index.html', request=request)
